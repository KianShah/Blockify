...
public:
   ...
   * You may want a recursive helper function for this one.
    */
	// If pct of the leaf nodes of the tree have an avg color within tol of the node
...
private:
   ...
   */
   void copy(const twoDtree & other);
	...
	void computeUlLr(stats & s, pair<int,int>& ul, pair<int,int>& lr);
	...
	void pruneAll(Node* subtree, double pct, int tol);
	...
	void shouldBePruned(Node* subtree, RGBAPixel root_node, int tol, double & leaf_nodes_prunable, double & leaf_nodes_total);
